...
for         → know the iterations — any data structures (array, string, object..)

while       → unknown iterations — any data structures (array, string, object..)

do-while    → executes at least once — any data structures (array, string, object..)

for...in    → loops through object keys — object

for...of    → loops through values of iterables — arrays and strings

forEach     → clean iteration over arrays — array
...
str.slice(1, 2)          // Extracts characters from index 1 to 2 (excluding 2)
str.concat()             // Joins the strings
str.replace("e", "a") 


// String Functions and Methods in JavaScript

// 1. trim() - removes extra spaces from both ends
let name = "   Hello guys   ";
console.log(name.trim()); // Output: "Hello guys"
...
// 3. reverse() - no direct method for strings, but we can do this:
let city = "Mangalore";
let reversed = city.split("").reverse().join("");
console.log(reversed); // Output: "erolagnaM"

// 4. replace() - replaces a character or substring
let fruit = "banana";
let changedFruit = fruit.replace("a", "o"); // only first occurrence
console.log(changedFruit); // Output: "bonana"

// 5. repeat() - repeats a string given number of times
let greet = "Hello! ";
console.log(greet.repeat(2)); // Output: "Hello! Hello! "
...
// 7. length - returns number of characters
let lang = "Python";
console.log(lang.length); // Output: 6

// 8. toUpperCase() - converts to uppercase
console.log(lang.toUpperCase()); // Output: "PYTHON"

// 9. toLowerCase() - converts to lowercase
let tech = "NODEJS";
console.log(tech.toLowerCase()); // Output: "nodejs"

// 10. slice(start, end) - returns part of the string
let code = "frontend";
console.log(code.slice(2, 6)); // Output: "onte"

// 11. replace() - can replace a word too
let quote = "Practice makes perfect";
console.log(quote.replace("perfect", "progress")); // Output: "Practice makes progress"

// 12. charAt(index) - gets character at index
let country = "India";
console.log(country.charAt(3)); // Output: "i"
